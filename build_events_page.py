...
<section class="hero">
  <div class="hero-inner">
    ...
    <p id="hero-sub">Find upcoming university events, education fairs, webinars, and study abroad briefings across Thailand, all in one place.<br><br>Updated weekly with events happening in the next 30 days. Follow StudyEventz on LINE for weekly event updates.</p>
  </div>
</section>
